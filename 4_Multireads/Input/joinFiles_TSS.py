...
first_file = "TSS_5ends_multireads/dWT1_TSS_multireads.tabular"
files = ["dWT2_TSS_multireads.tabular", "dWT3_TSS_multireads.tabular", "WT1_TSS_multireads.tabular", "WT2_TSS_multireads.tabular", "WT3_TSS_multireads.tabular",  "TV1_TSS_multireads.tabular", "TV2_TSS_multireads.tabular"]
dir_files = []
direct = "TSS_5ends_multireads"
for i in files:
...
combined_table = "multireads_TSS_5ends_combined_5sensing.txt"
