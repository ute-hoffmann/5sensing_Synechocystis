...
first_file = "PSS_5p_coverage/dWT1_PSS.tabular"
files = ["dWT2_PSS.tabular", "dWT3_PSS.tabular", "WT1_PSS.tabular", "WT2_PSS.tabular", "WT3_PSS.tabular",  "TV1_PSS.tabular", "TV2_PSS.tabular"]
dir_files = []
direct = "PSS_5p_coverage"
for i in files:
...
combined_table = "PSS_5ends_combined_5sensing.txt"
